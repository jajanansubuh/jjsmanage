  ...
  return (
    <Tabs defaultValue="suppliers" className="w-full relative z-10">
      <TabsList className="flex w-fit p-1.5 mb-10 bg-slate-900/50 backdrop-blur-md border border-white/5 rounded-2xl shadow-xl">
        ...
        <TabsTrigger value="products" className="flex items-center px-6 py-2.5 rounded-xl text-sm font-bold transition-all data-[state=active]:bg-emerald-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-emerald-500/20">
