...
import { History, Search, ChevronLeft, ChevronRight, Printer, Download } from "lucide-react";
      ...
      <CardHeader className="p-8 border-b border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="relative group">
            ...
            <Input placeholder="Cari suplier/nota..." className="pl-11 pr-4 h-14 w-64 bg-card/40 border border-white/5 rounded-2xl focus:border-emerald-500/30 focus:ring-4 focus:ring-emerald-500/10 focus:shadow-[0_0_15px_rgba(16,185,129,0.1)] transition-all duration-300 text-white placeholder-slate-500" value={deductionSearch} onChange={(e) => setDeductionSearch(e.target.value)} />
          </div>
        </div>
      </CardHeader>
